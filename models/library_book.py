...
class LibraryBook(models.Model):
    ...
    code = fields.Char(
        string="Mã Sách", required=False, copy=False, tracking=True,
        default=lambda self: self.env["ir.sequence"].next_by_code("library.book"),
    )
    ...
    def create(self, vals_list):
        ...
        for vals in vals_list:
            if not vals.get("code"):
                vals["code"] = sequence.next_by_code("library.book")
